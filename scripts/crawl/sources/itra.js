/**
 * ITRA (International Trail Running Association) — race calendar
 */
export const SOURCE_NAME = 'itra'
export const SOURCE_URLS = ['https://itra.run/Races/RaceCalendar']
...
export function parse(html, url, cheerioLoad, ctx) {
  ...
  $('a[href]').each((_, el) => {
    ...
    if (!/race|trail|ultra|event/i.test(href + ' ' + text)) return
