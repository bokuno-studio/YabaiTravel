/**
 * 123GO — Vietnamese marathon events
 */
export const SOURCE_NAME = '123go'
export const SOURCE_URLS = ['https://123go.vn/']
...
export function parse(html, url, cheerioLoad, ctx) {
  ...
  $('a[href]').each((_, el) => {
    ...
    if (!/race|event|marathon|run|chay/i.test(href + ' ' + text)) return
