/**
 * World's Marathons — global marathon directory
 */
export const SOURCE_NAME = 'worlds-marathons'
export const SOURCE_URLS = ['https://worldsmarathons.com/']
...
export function parse(html, url, cheerioLoad, ctx) {
  ...
  $('a[href]').each((_, el) => {
    ...
    if (!/marathon|race|event|run/i.test(href + ' ' + text)) return
