/**
 * RunABC — UK marathon events
 */
export const SOURCE_NAME = 'runabc'
export const SOURCE_URLS = ['https://runabc.co.uk/']
...
export function parse(html, url, cheerioLoad, ctx) {
  ...
  $('a[href]').each((_, el) => {
    ...
    races.push({ name: text, official_url: fullUrl, entry_url: fullUrl, race_type: RACE_TYPE, country: 'UK', source: SOURCE_NAME })
  })
