/**
 * Active.com — US running events
 */
export const SOURCE_NAME = 'active'
export const SOURCE_URLS = ['https://www.active.com/running']
...
export function parse(html, url, cheerioLoad, ctx) {
  ...
  $('a[href]').each((_, el) => {
    ...
    if (!/race|event|marathon|running|register/i.test(href + ' ' + text)) return
