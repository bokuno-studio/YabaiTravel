/**
 * JomRun — Malaysian marathon events
 */
export const SOURCE_NAME = 'jomrun'
export const SOURCE_URLS = ['https://www.jomrun.com/']
...
export function parse(html, url, cheerioLoad, ctx) {
  ...
  $('a[href]').each((_, el) => {
    ...
    races.push({ name: text, official_url: fullUrl, entry_url: fullUrl, race_type: RACE_TYPE, country: 'Malaysia', source: SOURCE_NAME })
  })
