...

{
  "event": {
    ...
    "race_type": "以下の分類基準に従って判定。marathon: ロードレース・マラソン・ハーフマラソン・リレーマラソン・ファンラン・ウルトラマラソン等の舗装路ランニング大会 | trail: トレイルランニング・山岳レース・ウルトラトレイル等の未舗装路ランニング大会 | triathlon: トライアスロン（スイム+バイク+ラン）・アクアスロン | cycling: 自転車レース・クリテリウム・ヒルクライム・ロングライド・グラベル・エンデューロ（自転車）・サイクルフェスタ | duathlon: デュアスロン（ラン+バイク+ラン） | rogaining: ロゲイニング・フォトロゲ | spartan: スパルタンレース | hyrox: HYROX | obstacle: OCR・障害物レース（スパルタン・HYROX以外） | adventure: アドベンチャーレース | devils_circuit: Devils Circuit | strong_viking: Strong Viking | other: 上記に該当しない場合のみ",
