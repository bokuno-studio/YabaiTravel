...
バックエンド（クローン）で巡回・データ取得に利用する URL。**このファイルのみ参照すること**（見落とし防止）。
...
| 種別 | URL |
|------|-----|
| World Series（レース一覧） | https://goldentrailseries.com/serie/world-series/#races |
...
| 種別 | URL |
|------|-----|
| RUNNET（ランニングポータル） | https://runnet.jp/ |
...
フィットネスレース。欧州・南北米・アジア太平洋・アフリカで開催。
...
| 種別 | URL |
|------|-----|
| Total Warrior（公式） | https://www.totalwarrior.co.uk/ |
